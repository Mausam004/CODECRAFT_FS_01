...
export const verifyOtp = async (req, res) => {
 ...
 const sql = "SELECT * FROM authentication WHERE email = ? and otp = ? and otp_expires > ? ";
...
export const sendResetPasswordMail = async (req, res) => {
  ...
  const sql = "UPDATE authentication SET otp = ? , otp_expires = ? WHERE email = ?";
...
export const resendResetPasswordMail = async (req, res) => {
  ...
  const sqlSelect = "SELECT otp_expires FROM authentication WHERE email = ?";
  ...
  db.query(sqlSelect, [email], (err, results) => {
    ...
    const sqlUpdate = "UPDATE authentication SET otp = ?, otp_expires = ? WHERE email = ?";
